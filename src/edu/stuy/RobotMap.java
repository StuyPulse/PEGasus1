...
public interface RobotMap extends PhysicalConstants {
    ...
    double AUTON_DRIVE_FORWARD_SCORING_PLATFORM_INCHES = ROBOT_LENGTH + AUTON_ZONE_WIDTH / 2 - 32;
    double AUTON_DRIVE_FORWARD_SCORING_PLATFORM_TIMEOUT = 5.2;
    double AUTON_DRIVE_FORWARD_DRIVER_SIDE_INCHES = AUTON_ONE_SET_DRIVE_INCHES_SECOND + TOTE_WIDTH + ROBOT_LENGTH - 32;
